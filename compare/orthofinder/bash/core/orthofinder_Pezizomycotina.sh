...
# === Define variables ===
LECANO_IN_DIR=/hpc/group/bio1/ewhisnant/comp-genomics/funannotate2/v25.09.29/lecanoromycetes
...
PHYLING_TREE=/work/edw36/comp-genomics/compare/phyling/lecanoromycetes/tree/consensus/pezizomycotina_final_tree_rerooted_v25.10.20.nwk
...
find "${LECANO_IN_DIR}" -path "*/annotate_results/*proteins.fa" -exec cp {} ${TEMP_DIR} \;
find "${PEZIZO_IN_DIR}" -path "*/annotate_results/*proteins.fa" -exec cp {} ${TEMP_DIR} \;
...
echo "$(ls ${TEMP_DIR} | wc -l) protein FASTA files copied to temporary directory and will be used for OrthoFinder analysis."
