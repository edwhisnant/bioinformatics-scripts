...
#SBATCH -c 32
#SBATCH --output=/hpc/group/bio1/ewhisnant/comp-genomics/compare/logs/cafe/v25.08.19/Results_Aug22/lecanoromycetes-top0-G2.out
#SBATCH --error=/hpc/group/bio1/ewhisnant/comp-genomics/compare/logs/cafe/v25.08.19/Results_Aug22/lecanoromycetes-top0-G2.err
#SBATCH --partition=common
#SBATCH -t 7-00:00:00
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=edw36@duke.edu
#SBATCH --job-name=cafe5-v25.08.14
...
OG_COPY_COUNT=/hpc/group/bio1/ewhisnant/comp-genomics/compare/orthofinder/lecanoromycetes/${VERSION}/${RESULTS_DIR}/Orthogroups/CAFE_Orthogroups.GeneCount.tsv
...
echo "Running CAFE5 using: ${GAMMA} Gamma categories, ${ITER} iterations, p-value threshold of 0.05, and a Poisson distribution for gene family size changes."
