...
class CAFE_fig():
    def __init__(self, report_cafe, families, clades, pb, pf,
        ...
        self.graphics_options = {
            ...
            'pixels_per_mya': 550.0,  # pixels per million years (tree width)
    ...
    def show_or_dump_tree(self, tree_obj, tree_style, fname, is_family=False):
        ...
        if self.dump:
            ...
            tree_obj.render(out_path, tree_style=tree_style, w=1200)
        else:
            # tree_obj.show(tree_style=tree_style)
            print("Display disabled. Use --dump to save figures instead.")
        return
